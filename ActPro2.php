...
$cod=$_REQUEST['codigo'];
$sql2="select * from proveedores where codigo='$cod'";
    ...
    <div class="container-fluid">
        ...
        <div class="row" style="margin-bottom: 10px">
            ...
            <div class="col-xl-8 offset-md-0">
                <div class="card">
                    <div class="card-body">
                        <h2 class="card-title">Actualización de Proveedor</h2>
                        <form action="ActPro3.php?codigo2=<?php echo"$cod"?>" method="post" onSubmit="if (!confirm('¿Desea guardar los cambios?')){return false;}">
